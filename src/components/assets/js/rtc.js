...
window.addEventListener("load", () => {
  ...
  if (!room) {
    ...
    stompClient.connect({}, function (frame) {
      ...
      stompClient.subscribe("/topic/new_user", (data) => {
        stompClient.send(
          "/app/newUserStart",
          {},
      ...
      stompClient.subscribe("/topic/newUserStart", (data) => {
        pc.push(data.sender);
        init(false, data.sender);
      });

      stompClient.subscribe("/topic/ice_candidates", async (data) => {
        data.candidate
      ...
      stompClient.subscribe("/topic/sdp", async (data) => {
